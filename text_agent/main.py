...
import uvicorn
import socketio
from sockets import image_queue, socketio_events_queue, sio
...
def main():
    ...
    try:
        ...
        processing_process = multiprocessing.Process(target=image_processing_function, args=(image_queue, socketio_events_queue))
